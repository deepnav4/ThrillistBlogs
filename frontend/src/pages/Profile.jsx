  ...
  useEffect(() => {
    ...
    const fetchUserProfile = async () => {
      try {
        ...
        setUserBlogs(data.user.blogs); // Get blogs from user object
      } catch (error) {
      ...
      <div className="min-h-screen pt-16 bg-gray-50 dark:bg-gray-900 font-['Inter',system-ui,-apple-system,sans-serif] transition-colors duration-300">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            {/* User Information Card - Reduced width */}
            <div className="lg:col-span-1">
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 sticky top-20">
                <div className="flex flex-col items-center">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">{user?.name}</h3>
                  ...
                  <div className="w-full space-y-4">
                    ...
                    <div className="flex items-center text-gray-600 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400 transition-colors">
                      ...
                      <span className="text-sm">Joined {new Date(user?.createdAt).toLocaleDateString('en-US', {
                        month: 'long',
                        year: 'numeric'
                      })}</span>
                    </div>
                    <div className="flex items-center text-gray-600 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400 transition-colors">
                      ...
                      <span className="text-sm">{userBlogs?.length} blogs posted</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="flex justify-between items-center mb-4">
                  <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">
                      You have published {userBlogs?.length} blogs
                    </p>
                  </div>
                  <button
